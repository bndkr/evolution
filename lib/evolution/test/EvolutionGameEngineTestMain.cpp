...
BOOST_AUTO_TEST_CASE(MatrixMultiplicationTest)
{
  ...
  multiplyTransformationMatrices(mat1, mat2);

  checkMatrixEquivalence(mat1, expected);
}
...
BOOST_AUTO_TEST_CASE(testScaleMatrix) {
  ...
  // clang-format off
  Mat4 expected = {
    2.0f, 6.0f, 12.0f, 4.0f,
    10.0f, 18.0f, 28.0f, 8.0f,
    18.0f, 30.0f, 44.0f, 12.0f,
    26.0f, 42.0f, 60.0f, 16.0f
  };
  // clang-format on

  scaleMatrix(matrix, x, y, z);
  checkMatrixEquivalence(matrix, expected);
}